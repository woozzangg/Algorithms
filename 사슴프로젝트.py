...
def deersnake(opp, turn, opp_prev, opp_last_pattern) :
	return random.randrange(0,3,2)

def allrandom(opp, turn, opp_prev, opp_last_pattern) :
	# 이 부분에 여러분의 알고리즘 구현이 들어갑니다
    # 여기에 아무것도 안적고 다같이 가는거로  확인
	return random.randrange(0,3) # 반드시 0 또는 1 또는 2로 리턴해야합니다


def Me22(opp, turn, opp_prev, opp_last_pattern) :
...
Register("deersnake", "deersnake")
Register("deersnake", "deersnake")
# Register("Opp1", "Opponent1")
# Register("Opp1", "Opponent1")
Register("allrandom", "allrandom")
Register("allrandom", "allrandom")
Register("allrandom", "allrandom")
